...
Node* List_createNewNode(DeviceType data){
...
List_StatusType List_addHead(DeviceType data){
...
List_StatusType List_addTail(DeviceType data){
...
List_StatusType List_addAtNth(DeviceType data, int32_t pos){       // pos = 1, 2, 3, ...
    List_StatusType status = LIST_OK;
    Node* pTmep1 = List_createNewNode(data);
    Node* pTemp2 = NULL;
    int32_t i;                                  // bien dem
